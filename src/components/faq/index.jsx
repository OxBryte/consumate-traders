        ...
        <>
            <ContainLayout>
                <VStack gap='64px' w='full' align='left' my='160px'>
                    ...
                    <Box bg='brand.600' p='56px' rounded='16px'>
                                ...
                                <AccordionItem border='none' bg='white' rounded='16px' p='24px' h='fit-content'>
                                    <h2>
                                        <AccordionButton _hover={{ bg: 'none' }}>
                                            <Box as="span" flex='1' textAlign='left' fontWeight={600} fontSize='20px' color='brand.100'>
                                                What is synthetic trading?
                                            </Box>
                                            <Box px='10px' py='8px' rounded='8px' color='blackAlpha.600' bg='brand.600' _expanded={{ bg: '#172929', color: 'white'}}>
                                                <AccordionIcon />
                                            </Box>
                                        </AccordionButton>
                                    </h2>
