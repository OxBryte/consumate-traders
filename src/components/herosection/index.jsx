...
function Herosection() {
    return (
        <>
            <Box w='full' maxH={{base:'1495px', md:'1643px', lg:'1040px'}} py='24px' bgGradient='linear(to-r, brand.400, brand.300)'>
                <ContainLayout>
                    <Navbar />
                    ...
                    <SimpleGrid columns={[1, 1, 1, 1, 3]} bg='brand.800' rounded='24px' borderWidth='1px' p='40px' my='240px' borderColor='brand.400' gap='24px' w='full'>
                        <VStack align='left' gap='18px'>
                            <Flex align='center' gap='16px'>
                                <Image src='/logo-with-border.svg' alt='' />
                                <Text fontWeight={700} fontSize='24px' color='brand.100'>24/7 Trading</Text>
                            </Flex>
                            <Text fontWeight={400} fontSize='20px' color='brand.200'>Seamless 24/7 trading access, encompassing weekends and public holidays, for non-stop investment opportunities and flexibility.</Text>
                        </VStack>
                        <VStack align='left' gap='18px'>
                            <Flex align='center' gap='16px'>
                                <Image src='/logo-with-border.svg' alt='' />
                                <Text fontWeight={700} fontSize='24px' color='brand.100'>High Volatility</Text>
                            </Flex>
                            <Text fontWeight={400} fontSize='20px' color='brand.200'>Due to its pronounced volatility, there's an increased likelihood of achieving greater profits and capital growth potential.</Text>
                        </VStack>
                        <VStack align='left' gap='18px'>
                            <Flex align='center' gap='16px'>
                                <Image src='/logo-with-border.svg' alt='' />
